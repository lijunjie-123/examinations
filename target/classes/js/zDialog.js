 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = 'Js/Dialog/skin/'; //图片路径配置
...
Dialog.getBgdiv = function () {
    ...
    if (!bgdiv) {
        ...
        var bgIframeMask = '<div id="_DialogBGMask" style="position:;background-color:#333;opacity:0.4;filter:alpha(opacity=40);width:100%;height:100%;"></div>';
