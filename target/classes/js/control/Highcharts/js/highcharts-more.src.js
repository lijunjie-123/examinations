	...
	init: function (options, chart, firstAxis) {
		...
		if (backgroundOption) {
			each([].concat(splat(backgroundOption)).reverse(), function (config) {
				var backgroundColor = config.backgroundColor; // if defined, replace the old client (specific for gradients)
...
var radialAxisMixin = {
	...
	/**
	 * In case of auto connect, add client closestPointRange to the max value right before
...
var GaugeSeries = {
	...
	/**
	 * Draw the points where each point is client needle
	 */
	drawPoints: function () {
...
seriesTypes.boxplot = extendClass(seriesTypes.column, {
	...
	/**
	 * One-to-client mapping from options to SVG attributes
	 */
...
(function () {
	...
	if (seriesTypes.spline) {
		/**
		 * Overridden method for calculating a spline from client point to the next
		 */
