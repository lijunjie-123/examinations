...
<div data-options="region:'north'"
    ...
    <div
            style="float: left; margin-top: 10px; font-size: 20px; font-weight: bold;">在线考试管理后台</div>
    ...
    <form id="fm" method="post">
        ...
        <div class="fitem">
            <label>确认新密码:</label> <input type="password" id="loginPassword2"
                                         name="loginPassword2" value="请输确认新密码"> <span
                style="width: 110px; font-style: normal; line-height: 49px; color: red; padding-left: 5px; font-size: 10px;"
